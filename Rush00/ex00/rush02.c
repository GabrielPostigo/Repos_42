...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/07 16:01:38 by ldazzani          #+#    #+#             */
/*   Updated: 2025/09/10 15:14:06 by zilji            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
o ULTIMA COLA POSICION UNO EN LA PRIMERA FILA;
en el segundo, en caso de que la primera condicion no se cumpla,
imprimira C EN LA PRIMERA COLA ULTIMA FILA;
O ULTIMA COLA Y FILA UNO;
